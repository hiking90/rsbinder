...
The generated Rust code uses a **newtype struct** wrapping the
corresponding integer type, with the enum values exposed as
...
defined variants. See [Enum and Union](./aidl-enum-union.md) for
